---
title: mã đề
description: Dược liệu Mã Đề (Hạt) từ bộ phận Hạt từ loài *Plantago major L.
date: 2024-12-01
categories:
  - Plantaginaceae
tags:
...
<figure markdown="span">
    ![Benzene and substituted derivatives.png](Plantago major/chemical structure/Benzene and substituted derivatives.png){ width=100% }
...
### Nhóm Benzofurans
<figure markdown="span">
    ![Benzofurans.png](Plantago major/chemical structure/Benzofurans.png){ width=100% }
...
<figure markdown="span">
    ![Carboxylic acids and derivatives.png](Plantago major/chemical structure/Carboxylic acids and derivatives.png){ width=100% }
...
<figure markdown="span">
    ![Cinnamic acids and derivatives.png](Plantago major/chemical structure/Cinnamic acids and derivatives.png){ width=100% }
...
### Nhóm Fatty Acyls
<figure markdown="span">
    ![Fatty Acyls.png](Plantago major/chemical structure/Fatty Acyls.png){ width=100% }
...
### Nhóm Flavonoids
<figure markdown="span">
    ![Flavonoids.png](Plantago major/chemical structure/Flavonoids.png){ width=100% }
...
<figure markdown="span">
    ![Hydroxy acids and derivatives.png](Plantago major/chemical structure/Hydroxy acids and derivatives.png){ width=100% }
...
<figure markdown="span">
    ![Organooxygen compounds.png](Plantago major/chemical structure/Organooxygen compounds.png){ width=100% }
...
### Nhóm Phenols
<figure markdown="span">
    ![Phenols.png](Plantago major/chemical structure/Phenols.png){ width=100% }
    <figcaption>Hình ảnh cấu trúc hóa học của 1 hoạt chất thuộc nhóm Phenols gồm ['tyrosol (LTS0132195)'].</figcaption>
</figure>
### Nhóm Prenol lipids
<figure markdown="span">
    ![Prenol lipids.png](Plantago major/chemical structure/Prenol lipids.png){ width=100% }
...
<figure markdown="span">
    ![Saturated hydrocarbons.png](Plantago major/chemical structure/Saturated hydrocarbons.png){ width=100% }
...
<figure markdown="span">
    ![Steroids and steroid derivatives.png](Plantago major/chemical structure/Steroids and steroid derivatives.png){ width=100% }
...
### Nhóm Tannins
<figure markdown="span">
    ![Tannins.png](Plantago major/chemical structure/Tannins.png){ width=100% }
